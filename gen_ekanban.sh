...
ruby script/rails generate redmine_plugin_model ekanban Kanban_State name:string is_default:boolean is_initial:boolean is_closed:boolean tracker_id:integer
